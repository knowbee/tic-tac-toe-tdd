...
class TestHumanVsHumanGameSession(unittest.TestCase):
    ...
    def test_when_first_player_is_O_player_one_symbol_should_be_O(self):
        ...
        self.assertEqual(self.human_vs_human.player_one.symbol,
                         "O", "If the first player is O, player one symbol should be O")
        self.assertEqual(self.human_vs_human.player_two.symbol,
    ...
    def test_if_first_player_X_current_player_symbol_should_be_X_when_game_starts(self):
        ...
        self.human_vs_human.set_player_symbols(first_player)
    ...
    def test_set_game_session_sets_players_symbols(self):
        ...
        self.assertEqual('X', self.human_vs_human.player_one.symbol,
                         'Incorrect symbol for first player.')
        self.assertEqual('O', self.human_vs_human.player_two.symbol,
                         'Incorrect symbol for second player.')

    def test_game_should_have_first_player_as_current_player_symbol(self):
        self.human_vs_human.set_game_players('X')

        self.assertEqual('X', self.human_vs_human.current_player_symbol,
